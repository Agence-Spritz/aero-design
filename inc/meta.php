...
$ogtitre='Mobilier Aviation | Objets d\'art | Aéro-Design Concept Store & Gallery';
$ogdescr='Galerie d\'Art et Concept store, vente et exposition d\'objets et de mobilier lié à l\univers de l\'aviation au Luxembourg.';

  // METAS SPECIAUX PAGES
  if (is_numeric($id)>0 && $pg=='page-blog')
  ...
  {	$table = $table_prefix."_pages"; 
	...
	$description=substr($textemeta,0,250);
	$keywords=motcle($titremeta).",".motcle($description);
  	$ogimg='http://'.$_SERVER['HTTP_HOST'].dirname($_SERVER["PHP_SELF"]).'/images/pages-mobilier-aviation-objet-art-avion-objet-aviateur/'.$IDmeta.'.jpg';
	$ogtitre=$ogtitre.": ".$titremeta;
	$ogdescr=$description;
  } 
