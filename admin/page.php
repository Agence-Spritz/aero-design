...
<!--
						...
						-->	        
							        ...
							        <div class="form-group">   
							          	<select name="<?=$chps[8]?>" class="form-control">
								          	<option value="1" <?php if($$chps[8]==1) {echo "selected";}  ?>>Modèle 1 (1 colonne : photos larges )</option>
								          	<option value="2" <?php if($$chps[8]==2) {echo "selected";}  ?>>Modèle 2 (3 colonnes : photos plus petites)</option>
								          	<option value="3" <?php if($$chps[8]==3) {echo "selected";}  ?>>Modèle 3 (Page de contenu basic)</option>
										</select>
							        </div>
					...
					<?php if($masquerdescription!=1) { ?>
				      <h4><i class='fa fa-align-justify '></i> Zone de texte principal</h4>
				      ...
				      <h4><i class='fa fa-align-justify '></i> Zone de texte secondaire</h4>
