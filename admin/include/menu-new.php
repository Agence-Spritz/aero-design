		...
		<nav class="navbar navbar-default">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
		        <li <?php  if (strpos($url,'page.php') !== false) { echo 'class="active"'; } ?> ><a href="page.php">Les Pages </a></li>
		        <li <?php  if (strpos($url,'diapo.php') !== false) { echo 'class="active"'; } ?>><a href="diapo.php">Diapo accueil</a></li>
		        <li <?php  if (strpos($url,'actus.php') !== false) { echo 'class="active"'; } ?> ><a href="blog.php">Les Billets </a></li>
